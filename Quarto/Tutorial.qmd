...
- Posit社が開発している[データサイエンスIDE](https://positron.posit.co/)
...
- おもにRを使うR初心者にはRStudioの方がおすすめ → 今回はRStudioを使用します
...
- 専門的な統計分析用のパッケージもいろいろ揃っている

- CRAN掲載分で、2026年4月現在、2万3000以上
...
RStudioからRを使うのがおすすめ → 今回はRStudioを使用します（2回目）
