...
- 2026.04版から[Posit AI](https://posit.co/products/ai)を統合

  ::: notes
  Posit AssistantとNext Edit Suggestions
  :::
...
- <abbr title="Comprehensive R Archive Network">[CRAN](https://cran.r-project.org/)</abbr> からインストーラーをダウンロード

  - [ミラー](https://cran.r-project.org/mirrors.html)
